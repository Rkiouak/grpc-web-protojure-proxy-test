(defproject grpc-web-test "0.0.1-SNAPSHOT"
  ...
  :profiles {:dev {:aliases {"run-dev" ["trampoline" "run" "-m" "grpc-web-test.server/run-dev"]}
                   :dependencies [[io.pedestal/pedestal.service-tools "0.5.7"]]}
             :uberjar {:aot [grpc-web-test.server]}}
  :main ^{:skip-aot true} grpc-web-test.server)
